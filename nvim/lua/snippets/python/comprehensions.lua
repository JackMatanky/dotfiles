-- ----------------------------------------------------------------------------
-- Filename: ~/dotfiles/nvim/lua/snippets/python/comprehensions.lua
...
return {
  s({
    ...
    c(4, { t(""), t(" if ") }),
    d(5, function(args)
      if #args[1] > 0 then return s(nil, { i(1, "condition") })
      else return s(nil, {}) end
    end, { 4 }),
    t("]"),
    i(0),
  }),
  ...
  s({
    ...
    t("{"), i(1, "key"), t(": "), i(2, "value"), t(" for "), i(3, "k"), t(", "), i(4, "v"), t(" in "), i(
    5, "iterable"),
    c(6, { t(""), t(" if ") }),
    d(7, function(args)
      if #args[1] > 0 then return s(nil, { i(1, "condition") })
