...
# }
{
  ...
  programs.alacritty = {
    ...
    settings = {
      ...
      # Define font size and other font settings
      font = {
        size = 12;
      };
      ...
      # Launch shell with Starship loaded
      shell = {
        program = pkgs.zsh; # Or replace with pkgs.bash or pkgs.nushell if preferred
        args = ["-l"]; # Start as a login shell to load Starship config
      };
    };
  };
}
